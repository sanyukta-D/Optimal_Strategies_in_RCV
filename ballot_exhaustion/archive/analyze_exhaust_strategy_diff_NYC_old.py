"""
Archived: Duplicate of case_studies/nyc/analyze_exhaust_strategy_diff.py.
Originally at case_studies/NewYork_City_RCV/analyze_exhaust_strategy_diff.py.

Identical copy — the canonical version lives in case_studies/nyc/.
Neither copy is imported anywhere; both are standalone scripts.
